...
namespace Group3_iFINANCEAPP.Controllers
{
    public class AdministratorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,name,dateHired,dateFinished,userShadow")] Administrator administrator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,name,dateHired,dateFinished,userShadow")] Administrator administrator)
        {
            if (ModelState.IsValid)
            {
